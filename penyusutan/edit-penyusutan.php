...
$barang = query("SELECT * FROM tb_penyusutan WHERE id_penyusutan = $id_penyusutan")[0];
$aset = query("SELECT * FROM tb_aset");
// var_dump($barang);
if ( isset($_POST["submit"]) ) {
  if ( edit_penyusutan($_POST) > 0 ) {
    echo "
        <script>
    ...
    echo "
        <script>
          ...
          document.location.href = 'edit-penyusutan.php';
        </script>
        "
    ;
  }
              ...
              <div class="mb-0 text-gray-800">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <input class="form-control" type="hidden" name="id_penyusutan" value="<?php echo $barang["id_penyusutan"]; ?>">
                      <table class="table" width="25%" border="0">
                          <tr>
                              <td>Nama Aset</td>
                              <td>
                              <select name="id_aset" id="id_aset">
                                <?php foreach ($aset as $br) : ?>
                                  <option value="<?php echo $br["id_aset"]; ?>"><?php echo $br["nama_aset"]; ?></option>
                                <?php endforeach; ?>
                              </select>
                              </td>
                          </tr>

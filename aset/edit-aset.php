...
$barang = query("SELECT * FROM tb_aset WHERE id_aset = $id_aset")[0];
  ...
  if ( edit_aset($_POST) > 0 ) {
    ...
    echo "
        <script>
          ...
          document.location.href = 'edit-aset.php';
        </script>
        "
    ;
  }
              ...
              <div class="mb-0 text-gray-800">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <input class="form-control" type="hidden" name="id_aset" value="<?php echo $barang["id_aset"]; ?>">
                      <table class="table" width="25%" border="0">
                          <tr>
                              <td>Nama Aset</td>
                              <td>
                                <input class="form-control" type="text" name="nama_aset" value="<?php echo $barang["nama_aset"]; ?>">
                              </td>
                          </tr>
                          <tr>
                            <td>Keterangan</td>
                            <td>
                              <input class="form-control" type="text" name="keterangan" value="<?php echo $barang["keterangan"]; ?>">
                            </td>
                          </tr>
                          <tr>
                            <td>Kategori</td>
                          ...
                          <tr>
                              <td>Jumlah Aset</td>
                              <td>
                                <input class="form-control" type="text" name="jumlah_aset" value="<?php echo $barang["jumlah_aset"]; ?>">
                              </td>
                          </tr>
                          <tr>
                              <td>Lokasi Aset</td>
                          ...
                          <tr>
                              ...
                              <td>
                                <input class="form-control" type="date" name="tgl_peroleh" value="<?php echo $barang["tgl_peroleh"]; ?>">
                              </td>
                          </tr>
                          ...
                          <tr>
                              <td>Masa Manfaat</td>
                              <td>
                                <input class="form-control" type="text" name="masa_manfaat" value="<?php echo $barang["masa_manfaat"]; ?>">
                              </td>
                          </tr>
                          <tr>
                              <td>Harga Perolehan</td>
                              <td>
                                <input class="form-control" type="text" name="harga_peroleh" value="<?php echo $barang["harga_peroleh"]; ?>">
                              </td>
                          </tr>
                          <tr>
                              <td>Status Aset</td>

...
$barang = query("SELECT * FROM tb_aset JOIN tb_kategori JOIN tb_lokasi WHERE id_aset = $id_aset")[0];
?>
<!DOCTYPE html>
<html lang="en">
  <head>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tr>
                            <td> Status Aset :</td>
                            <td><?php echo $barang["status_aset"]; ?></td>
                        </tr>
                        <tr>
                            <td>Kondisi Aset :</td>
                            <td><?php echo $barang["kondisi_aset"]; ?></td>
                        </tr>
                        <tr>
                            <td>Keterangan :</td>
                    ...
                    <a href="add-aset.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm mb-3"><i class="fas fa-download fa-sm text-white-50"></i> Download Data Aset </a>
                  </div>
                </div>
              </div>
            </div>
